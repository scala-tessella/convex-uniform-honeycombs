...
/** Certificate `species-table.txt`. The species table: every support with its realized vertex species, assembled on the sphere of directions
  * and deduplicated by canonical combinatorial-map key.
  *
